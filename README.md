...
This repository run _locust_ tests over 3 different WSGI (bjoern[^1], granian[^4], gunicorn[^2]) and ASGI (uvicorn[^3]) Python servers using [GitLab-SaaS runners](https://docs.gitlab.com/ee/ci/runners/saas/linux_saas_runner.html), based on 2 vCPUs & 8 GB of RAM.

## Results

- [bjoern](https://python-testing.gitlab.io/flask-servers-testing/bjoern-locust-report.html)
- [granian](https://python-testing.gitlab.io/flask-servers-testing/granian-locust-report.html)
...
[^4]: https://github.com/emmett-framework/granian
